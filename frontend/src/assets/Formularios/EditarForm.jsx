...
const EditarForm = ({ cerrar, confirmar, datosEditar }) => {
  ...
  const [caracteristicaActuales, setCaracteristicasActuales] = useState(datosEditar.caracteristicas || [])
  useEffect(() => {
  ...
  console.log(caracteristicaActuales)
  ...
  const handleAgregarCaracteristica = () => {
    ...
    if (
      ...
      !caracteristicaActuales.some((c) => c.id === caracteristicaSeleccionada.id)
    ) {
      setCaracteristicasActuales((prev) => [...prev, caracteristicaSeleccionada]);
  ...
  const handleSubmit = async (e) => {
    ...
    data.append("caracteristicas", JSON.stringify(caracteristicaActuales.map(c=> c.id)))
        ...
        >
          ...
          <div className="flex flex-col w-full justify-between gap-2">
           <label className="">
              ...
              </label> <div className="w-full border rounded p-3 bg-gray-50 min-h-[100px]">

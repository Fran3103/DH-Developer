...
if (error) {
  ...
  const productosActuales = datos.slice(indicePrimerProducto, indiceUltimoProducto);
  ...
  return (
    <div className='m-auto pt-24 max-w-[1240px]'>
        <h1 className='w-full m-auto mb-4 text-center md:text-left md:text-2xl font-semibold text-azul '>Productos: </h1>

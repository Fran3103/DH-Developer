...
const Hotel = (({id, category, name, location, rating, quality,  price, images}) => {
             ...
             <div className='flex flex-col justify-between items-center w-full m-auto gap-3 max-w-[1240px] xs:flex-wrap xs:flex-row xs:gap-0 sm:flex-row sm:gap-3'>
                 ...
                 <Link key={id} to={`/${category}/${id}`}>
                     ...
                     <div className='p-2 flex flex-col text-sm'>
                         ...
                         <p>{location}</p>
                         <p className='py-2'><span className='p-2 py-[2px] bg-azul text-white font-semibold rounded-3xl'>{rating}</span> {quality} - </p>
                     </div>
